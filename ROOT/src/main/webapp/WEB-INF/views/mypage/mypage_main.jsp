	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default text-center col-sm-5">
				<div class="lg-box panel-body">
					<div class="col-sm-3">
						<a class="mypage-a" href="#">
						<span class="glyphicon glyphicon-pencil" aria-hidden="true" aria-hidden="true"></span>
						<br>내 정보<br>수정</a>
					</div>
					<div class="col-sm-3">
						<a class="mypage-a" href="#">
						<span class="glyphicon glyphicon-stats" aria-hidden="true" aria-hidden="true"></span>
						<br>내 신용도<br>조회</a>
					</div>
					<div class="col-sm-3">
						<a class="mypage-a" href="">
						<span class="glyphicon glyphicon-cloud" aria-hidden="true" aria-hidden="true"></span>
						<br>내 계좌<br>관리
						</a>
					</div>
					<div class="col-sm-3">						
						<a class="mypage-a" href="#">
						<span class="glyphicon glyphicon-list-alt" aria-hidden="true" aria-hidden="true"></span>
						<br>캐쉬 내역<br>조회</a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-12 md-box">
				...
				<span class="pull-right">구매관리 바로가기</span>
				</a>
				</h3>
			</div>
			<div class="table">
			...
			<div class="col-sm-12 md-box">
				...
				<a class="mypage-a" href="#">
				<span class="pull-right glyphicon glyphicon-plus"></span>
				<span class="pull-right">판매관리 바로가기</span>
				</a>
				</h3>
			</div>
			<div class="table">
