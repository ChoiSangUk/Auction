...
<div class="container-fluid">
	...
	<div class="col-sm-10">
		...
		<div class="row title">
			...
			<span>></span> <span style="color: #1266FF">내 계좌등록</span>
			<h2>나의 정보관리</h2>
		</div>
		<!-- 내용1 -->
			...
			<form role="form" id="AccountInsertForm"
				...
				<div class="form-group">
					<label for="accountBankName">은행명</label> <input type="text"
						class="form-control" id="accountBankName" name="accountBankName" placeholder="은행명">
				</div>
				<div class="form-group">
					<label for="accountHolderName">예금주</label> <input type="text"
						class="form-control" id="accountHolderName" name="accountHolderName"
						placeholder="예금주" value="${userLoginInfo.userName}">
				</div>
				<div class="form-group">
					...
					<button type="submit" class="btn btn-info">
						계좌등록<i class="fa fa-check spaceLeft"></i>
					</button>
			</form>
		</div>
	</div>
