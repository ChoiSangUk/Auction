		...
		$.ajax({
            ...
            success: function(getData){
            	...
            	for(var i = 0; i<getData.length; i++){
            		//var divTag = $('<div></div>')
            		//var sapnTag = $('<span></span>')
            		//divTag.append(sapnTag)
              		//$('아이디')append(divTag)
              		console.log(getData);
            	}
            	
            	$.each(getData, function(i, largeCategory){
	...
	<div class="row content">
		<div class="col-sm-12 text-left">
			...
			<form class="form-horizontal"
				...
				<input type="text" id="largeCategoryCode" name="largeCategoryCode"
					value="" /> <input type="text" id="middleCategoryCode"
					name="middleCategoryCode" value="" /> <input type="text"
					id="smallCategoryCode" name="smallCategoryCode" value="" />
				<div class="container">
					<h2>대분류 카테고리 선택</h2>
