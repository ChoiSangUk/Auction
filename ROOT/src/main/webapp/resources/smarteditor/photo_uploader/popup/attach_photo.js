    ...
    function html5Upload() {	
    	...
    	sUploadURL= getContextPath()+'/multipleAjax'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : getContextPath()+'/singleAjax',	//샘플 URL입니다.
 	        sCallback : getContextPath()+'/resources/smarteditor/popup/callback.jsp',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
